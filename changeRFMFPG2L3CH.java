 ...
 * 
 */
public class changeRFMFPG2L3CH {
    ...
    public static void main(String[] args)throws IOException{
        ...
        //put map(Goo_No, M_No) map(Goo_No, Name)
        ...
        for(int i=1;i<5;i++){
            BufferedReader bfr1 = new BufferedReader(
                new FileReader("../RFM_Association/華山店/華山201409201508/華山201409201508_FPG_"+i+".txt"));
        
            BufferedWriter bfw = new BufferedWriter(
                new FileWriter("../RFM_Association/華山店/華山201409201508/tttt華山201409201508_FPG_CH_"+i+".csv"));            
            ...
            while(( line = bfr1.readLine()) != null ){
                ...
                bfw.append(str.trim() + "," + nt.format(percent) + "," + nt.format(Double.parseDouble(confdata[1]) ));
                bfw.newLine();
